...
public class Tester {
    ...
    public static void checkIsEmpty(Tree t) throws Exception{
        //if tree t is an instance of emptyBST --> isEmpty should return true
        //if tree t is an instance of NonEmptyBST --> isEmpty should return false
        
        if (t instanceof EmptyBST){
            if(!t.isEmpty()){
                throw new Exception("All is not good, this tree is not empty.");
  
            }
        }else if(t instanceof NonEmptyBST){
            if(t.isEmpty()){
                throw new Exception("All is not good,this tree is empty.");
            }
    }
